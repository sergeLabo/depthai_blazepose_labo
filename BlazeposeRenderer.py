...
class BlazeposeRenderer:
    ...
    def __init__(self, tracker, **config):
        ...
        if output is None:
            ...
            self.output = cv2.VideoWriter(  output,
                                            fourcc,
                                            tracker.video_fps,
    ...
    def draw_landmarks(self, body):
        ...
        if self.show_xyz and body.xyz_ref:
            ...
            cv2.rectangle(self.frame, (x0,y0), (x0+250, y0+110), (220,220,240), -1)
            ...
            cv2.putText(self.frame, f"Z:{body.xyz[2]/10:3.0f} cm", (x0+10, y0+90), cv2.FONT_HERSHEY_PLAIN, 3, (0,0,255), 3)
